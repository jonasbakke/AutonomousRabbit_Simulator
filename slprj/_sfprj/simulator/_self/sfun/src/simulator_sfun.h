#ifndef __simulator_sfun_h__
#define __simulator_sfun_h__
...
extern mxArray* load_simulator_optimization_info(boolean_T isRtwGen, boolean_T
  isModelRef, boolean_T isExternal);
extern void unload_simulator_optimization_info(void);
